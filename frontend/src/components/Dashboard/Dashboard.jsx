...
export function Dashboard() {
    ...
    const fetchDashboardData = async () => {
        try {
            const response = await fetch('https://agriequip-backend-api.vercel.app/api/dashboard', {
                headers: {
    ...
    const fetchProducts = async () => {
        try {
            const response = await fetch(`https://agriequip-backend-api.vercel.app/api/products?location=${selectedAddress}&category=${category}`);
            const data = await response.json();
            setProducts(data);
        } catch (error) {
    ...
    const handleAddProduct = async () => {
        ...
        try {
            const response = await fetch('https://agriequip-backend-api.vercel.app/api/products', {
                method: 'POST',
                headers: {
    ...
    const handleDeleteProduct = async (productId) => {
        try {
            const response = await fetch(`https://agriequip-backend-api.vercel.app/api/products/${productId}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${user.token}`,
                    'Content-Type': 'application/json'
